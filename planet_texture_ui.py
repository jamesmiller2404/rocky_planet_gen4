...
PARAM_GROUPS = [
    ...
    },
    {
        ...
        "params": [
            ...
            ("plate_boundary_strength", 0.00, 1.00, 0.01),
            ("peak_prominence", 0.00, 1.00, 0.01),
            ("erosion_strength", 0.00, 1.00, 0.01),
        ],
    },
    {
        "name": "Impact Craters",
        "params": [
            ...
            ("crater_rim_vault", 0.00, 1.00, 0.01),
            ("crater_rim_color_shift", -1.00, 1.00, 0.01),
            ("crater_rim_color_variation", 0.00, 1.00, 0.01),
            ("crater_ancient_bombardment", 0.00, 1.00, 0.01),
            ("crater_middle_bombardment", 0.00, 1.00, 0.01),
            ("crater_fresh_bombardment", 0.00, 1.00, 0.01),
            ("crater_ancient_erosion", 0.00, 1.00, 0.01),
            ("crater_middle_erosion", 0.00, 1.00, 0.01),
            ("crater_fresh_erosion", 0.00, 1.00, 0.01),
            ("crater_erosion_cycles", 0, 6, 1),
            ("crater_rim_breakup", 0.00, 1.00, 0.01),
            ("crater_wall_terracing", 0.00, 1.00, 0.01),
            ("crater_central_peak_strength", 0.00, 1.00, 0.01),
            ("crater_central_peak_height", 0.00, 1.00, 0.01),
            ("crater_central_peak_sharpness", 0.00, 1.00, 0.01),
            ("crater_shadow_strength", 0.00, 1.00, 0.01),
            ("crater_floor_dust_fill", 0.00, 1.00, 0.01),
    ...
    },
    {
        ...
        "params": [
            ...
            ("color_brightness", -0.50, 0.50, 0.01),
...
PARAM_LABELS = {
    ...
    "plate_boundary_strength": "Plate boundary strength",
    ...
    "crater_rim_vault": "Rim vault",
    "crater_rim_color_shift": "Rim color",
    "crater_rim_color_variation": "Rim color variation",
    "crater_ancient_bombardment": "Ancient bombardment",
    "crater_middle_bombardment": "Middle bombardment",
    "crater_fresh_bombardment": "Fresh bombardment",
    "crater_ancient_erosion": "Ancient erosion",
    "crater_middle_erosion": "Middle erosion",
    "crater_fresh_erosion": "Fresh erosion",
    "crater_erosion_cycles": "Erosion cycles",
    "crater_rim_breakup": "Rim breakup",
    "crater_wall_terracing": "Wall terracing",
    "crater_central_peak_strength": "Central peaks",
    "crater_central_peak_height": "Peak height",
    "crater_central_peak_sharpness": "Peak sharpness",
    "crater_shadow_strength": "Crater shadow",
    "crater_floor_dust_fill": "Floor dust fill",
    ...
    "color_brightness": "Final brightness",
